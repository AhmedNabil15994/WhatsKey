		...
		if(index != 'actions'){
			...
			columnDefsVar.push({
				...
				render: function(data, type, full, meta) {
                    ...
                    if((designElems.mainData.url == 'contactUs') ){
						showButton = '<a href="/'+designElems.mainData.url+'/reply/'+full.id+'" class="action-icon btn btn-block btn-outline-info"> <i class="si si-eye"></i> '+replyText+'</a>';
					}
					...
					if(designElems.mainData.url == 'invoices'){
						editButton = '';
					}

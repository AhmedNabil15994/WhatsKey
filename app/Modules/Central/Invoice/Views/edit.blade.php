            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ URL::to('/'.$data->designElems['mainData']['url'].'/update/'.$data->data->id) }}">
                        ...
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">{{ trans('main.discount_type') }} :</label>
                            <div class="col-9">
                        ...
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">{{ trans('main.discount_value') }} :</label>
                            <div class="col-9">
                                <input type="text" name="discount_value" class="form-control" value="{{ $data->data->discount_value }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group mt-3 mb-0 justify-content-end row">
                            <div class="col-9">
                                <button class="btn btn-success AddBTNz" type="submit">{{ trans('main.edit') }}</button>
...
@section('scripts')
<!--<script src="{{ asset('assets/dashboard/assets/components/editInvoice.js') }}" type="text/javascript"></script>-->
@endsection
...
class SliderControllers extends Controller {
    ...
    public function edit($id) {
        ...
        $userObj = Slider::NotDeleted()->find($id);
        if($userObj == null) {
            return Redirect('404');
        }

        $data['data'] = Slider::getData($userObj);
        $data['designElems'] = $this->getData();
        $data['designElems']['mainData']['title'] = trans('main.edit') . ' '.trans('main.sliders') ;
        $data['designElems']['mainData']['icon'] = 'fa fa-pencil-alt';
        $data['pages'] = Page::dataList(1)['data'];
        return view('Central.Slider.Views.edit')->with('data', (object) $data);      
    }
    ...
    public function update($id) {
        ...
        $input = \Request::all();
        // dd($input);
        $dataObj = Slider::NotDeleted()->find($id);
        if($dataObj == null) {
            return Redirect('404');
        }
    ...
    public function add() {
        $data['designElems'] = $this->getData();
        $data['designElems']['mainData']['title'] = trans('main.add') . ' '.trans('main.sliders') ;
        $data['designElems']['mainData']['icon'] = 'fa fa-plus';
        $data['pages'] = Page::dataList(1)['data'];
        return view('Central.Slider.Views.add')->with('data', (object) $data);
    }
    ...
    public function create() {
        ...
        $dataObj->description_en = $input['description_en'];
        $dataObj->page_id = $input['page_id'];
        $dataObj->sort = Slider::newSortIndex();

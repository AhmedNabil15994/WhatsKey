        ...
        <div class="col-lg-4 col-xl-4">
            <div class="card text-center" style="padding: 20px;">
                ...
                <div class="text-left mt-3">
                    ...
                    <p class="text-muted mb-1 font-13"><strong>{{ trans('main.channel') }} :</strong> <span class="ml-2"># {{ @$data->channel->instanceId }}</span></p>
            ...
            <div class="card">
                ...
                <div class="inbox-widget" data-simplebar style="max-height: 350px;">
                    ...
                    <div class="main-mail-item">
                        <div class="main-img-user"><img alt="" src="{{ asset('assets/dashboard/assets/images/logoOnly.jpg') }}"></div>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-2">
                                        <img src="{{ asset('assets/dashboard/assets/images/logoOnly.jpg') }}" width="100%" alt="">
                                    </div>
                                    <div class="col-10">
                                        <div class="row">
                                            <!--begin::Title-->
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr data-cols="{{$data->data->membership_id}}" data-type="1">
                                ...
                                <td>
                                    <input class="form-control datepicker" value="{{ date('m/d/Y',strtotime(@$data->channel->start_date)) }}" name="start_date" placeholder="{{ trans('main.start_date') }}">
                                </td>
                                <td>
                                    <input class="form-control datepicker" value="{{ date('m/d/Y',strtotime(@$data->channel->end_date)) }}" name="end_date" placeholder="{{ trans('main.end_date') }}">
                                </td>
                            </tr>
                            ...
                            <tr data-cols="{{$addon->Addon->id}}" data-type="2">
                                ...
                                <td>
                                    <input class="form-control datepicker" value="{{ date('m/d/Y',strtotime($addon->start_date)) }}" name="start_date" placeholder="{{ trans('main.start_date') }}">
                                </td>
                                <td>
                                    <input class="form-control datepicker" value="{{ date('m/d/Y',strtotime($addon->end_date)) }}" name="end_date" placeholder="{{ trans('main.end_date') }}">
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
<script src="{{ asset('assets/dashboard/assets/V5/components/subscription.js') }}" type="text/javascript"></script>
@endsection
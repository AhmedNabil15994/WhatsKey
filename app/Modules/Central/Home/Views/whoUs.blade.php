...
<div class="whoUs" id="dataSection">
	<div class="container">
		<div class="row">
			...
			<h2>من نحن</h2>
			<p>
				خدمة واتس كي مقدمة من قِبل مركز الخوادم الرقمية للإتصالات وتقنية المعلومات التي تأسست عام ٢٠٠٤م, تميزنا من خلال سنوات الخبرة بتقديم باقات متكاملة من المنتجات والحلول والخدمات التقنية المتنوعة لنسطر نجاحات متوالية قائمة على سياستنا الرامية إلى خلق وإيجاد خدمات نوعية متميزة تلبي تطلعات عملائنا في كافة القطاعات المختلفة بدأ بالأفراد والشركات بمختلف أحجامها وانتهاءً بالقطاعات والمنظمات الحكومية
			</p>
		</div>
	</div>
</div>

...
class TemplateMsg extends Model{
    ...
    protected $fillable = ['id','channel','message_type','message','title','image','body','footer','buttons','buttonsData','sort','status','created_by','created_at'];    
    ...
    static function getPhotoPath($id, $photo,$tenantId=null) {
        return \ImagesHelper::GetImagePath('templateMsgs', $id, $photo,false,$tenantId);
    }

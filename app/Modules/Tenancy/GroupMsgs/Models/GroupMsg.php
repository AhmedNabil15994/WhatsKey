...
class GroupMsg extends Model{
    ...
    protected $fillable = ['id','channel','group_id','messages_count','message_type','later','publish_at','message','file_name','https_url','url_title','url_desc','url_image','whatsapp_no','lat','lng','address','status','bot_plus_id','list_id','poll_id','template_id','created_by','created_at'];    

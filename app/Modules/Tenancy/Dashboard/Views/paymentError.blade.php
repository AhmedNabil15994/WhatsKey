...
@section('title',trans('main.paymentFailed'))
@section('pageName',trans('main.paymentFailed'))
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="timer text-center card p-5">
                <img src="{{ asset('assets/tenant/images/img_8.png') }}" alt="">
                ...
                <div class="Attention">
                    ...
                    <a href="{{URL::to('/dashboard')}}">{{ trans('main.dashboard') }}</a>
                </div>
            </div>
        </div>

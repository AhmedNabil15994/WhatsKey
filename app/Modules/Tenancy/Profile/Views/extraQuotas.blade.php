                            ...
                            <div class="carousel-inner">
                                <div class="col-11 col-lg-12 col-xxl-10 mx-auto">
                                    <div class="carousel-item active"> 
                                        <div class="row mb-5">
                                        @foreach($data->extraQuotas as $key => $membership)
                                        @if($key % 3 == 0 && $key != 0)
                                        </div></div><div class="carousel-item"> <div class="row mb-5">
                                        @endif
                                        <div class="col-md-4 p-0 package">
                                            <div class="pt-30 card mx-2 pt-md-25  text-center">
                                                ...
                                                <div class="mt-7">
                                                    <a href="#" data-area="1" data-tab="{{$membership->id}}" class="w-100 mediaBtn btn btn-primary text-uppercase font-weight-bolder px-15 py-3">{{trans('main.addToCart')}}</a>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach

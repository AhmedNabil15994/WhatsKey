		        ...
		        <div class="row justify-content-center pt-8 px-8 pt-md-27 px-md-0">
		            <div class="col-md-12">
			                    ...
			                    <div class="d-flex flex-column align-items-md-end px-0">
			                        <a href="#" class="mb-5 max-w-200px">
			                            <span class="svg-icon svg-icon-full">
			                                <img src="{{!isset($data->logoFile) ? str_replace('myDomain',DOMAIN,config('app.BASE_URL')).'/assets/images/whiteLogo.png' : $data->logoFile}}" alt="">
			                            </span>
			                        </a>
		                ...
		                <div class="rounded-xl overflow-hidden w-100 max-h-md-250px mb-10">
		                    <img src="{{!isset($data->backFile) ? str_replace('myDomain',DOMAIN,config('app.BASE_URL')).'/assets/tenant/media/bg/bg-invoice-5.jpg' : $data->backFile}}" class="w-100" alt="">
		                </div>
		                <!--begin: Invoice body-->

        ...
        foreach($userAddons as $userAddon){
            if($userAddon->Client){
                ...
                if($userAddon->addon_id == 4){
                    // Zid Webhooks
                    $webhookUrl = str_replace('://', '://'.$domain.'.', config('app.BASE_URL')).'/services/webhooks/zid-webhook';
                    ...
                    // Salla Webhooks
                    $webhookUrl = str_replace('://', '://'.$domain.'.', config('app.BASE_URL')).'/services/webhooks/salla-webhook';

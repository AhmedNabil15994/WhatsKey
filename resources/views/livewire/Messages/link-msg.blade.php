<div>
    ...
    <div class="link">
        <div class="replyHeader py-3 px-3 mb-3">
            ...
            <span class="text-muted d-block">{{isset($msg['metadata']['description']) && $msg['metadata']['description'] != '' ? $msg['metadata']['description'] : str_replace('https://','',$msg['metadata']['matchedText'])}}</span>
        </div>
        <div>

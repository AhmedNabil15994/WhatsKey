<div class="msgD {{$msg['fromMe'] == 1 ? 'left':'right mb-5'}}">
    @php 
        $msg = (array) $msg; 
    ...
    @endif
    @if($msg['fromMe'])
    <div class="text-dark text-right font-weight-bolder mb-5 {{count($msg['reactions']) > 0 && !empty($msg['reactions']) && isset($msg['reactions'][0]['id']) && $msg['reactions'][0]['body'] != null ? 'mt-6' : 'mt-2'}} bg-gray-100 px-2 pt-1 w-fit float-right" style="z-index: 999;position: relative;width: fit-content;border-radius: 5px">{{$msg['status']}}</div>    
    @endif

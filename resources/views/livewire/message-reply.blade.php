<div>
    ...
    <div class="replyHeader py-3 px-3 d-flex align-items-center mb-1 replyMsg" data-id="{{array_reverse(explode('_',$msg['metadata']['quotedMessageId']))[0]}}" style="min-width: 200px;">

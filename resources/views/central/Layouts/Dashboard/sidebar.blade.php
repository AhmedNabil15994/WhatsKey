                            ...
                            <div class="card  pricing-card overflow-hidden">
                                ...
                                <div class="pt-3 emoji">
                                    <div class="ml-auto mb-3 text-muted text-center">
                                        <img class="emoji-img" data-area="1" src="{{ asset('assets/dashboard/assets/emoji/1.svg') }}" alt="">
                                        <img class="emoji-img" data-area="2" src="{{ asset('assets/dashboard/assets/emoji/2.svg') }}" alt="">
                                        <img class="emoji-img" data-area="3" src="{{ asset('assets/dashboard/assets/emoji/3.svg') }}" alt="">
                                        <img class="emoji-img" data-area="4" src="{{ asset('assets/dashboard/assets/emoji/4.svg') }}" alt="">
                                        <img class="emoji-img" data-area="5" src="{{ asset('assets/dashboard/assets/emoji/5.svg') }}" alt="">
                                    </div>
